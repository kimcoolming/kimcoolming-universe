import{_ as $,a}from"./BodyMaincard-CSOWW-Yc.js";import{C as v}from"./CodeBlock-Etr-AdjA.js";import{c as H,w as e,r as n,o as p,b as t,a as i,g as l,u as f,e as L,F as T,f as U}from"./index-KLpfFNps.js";const J={__name:"card-list",setup(q){const b=[{title:"컴포넌트",key:"component"},{title:"설명",key:"description"}],x=[{component:"v-card",description:"기본 카드 컴포넌트"},{component:"v-card-title, v-card-text, v-card-actions",description:"카드의 구조 구성 요소"},{component:"v-img",description:"카드 내 이미지 삽입용 컴포넌트"},{component:"elevation, rounded",description:"디자인 속성 (그림자, 둥글기 등)"},{component:"v-list, v-list-item",description:"목록 표현용 리스트 컴포넌트"}],g=`
<template>
  <v-card>
