import{_ as V,a as c}from"./BodyMaincard-DmKPXyfh.js";import{C as u}from"./CodeBlock-Kf1mY0YT.js";import{c as w,w as e,r as l,o as B,b as t,a,g as n,u as m}from"./index-CSyGLtmB.js";const D={__name:"button-icon",setup(C){const v=[{title:"버튼 타입",key:"type"},{title:"설명",key:"description"}],p=[{type:"v-btn",description:"기본 버튼"},{type:'variant="outlined"',description:"외곽선 버튼"},{type:'variant="text"',description:"텍스트만 있는 버튼"},{type:"icon",description:"아이콘 전용 버튼 (v-icon과 함께 사용)"}],_=`
<template>
  <v-row>
