import{_ as H,a as r}from"./BodyMaincard-BHSez2PV.js";import{C as o}from"./CodeBlock-qOhL21vW.js";import{c as V,w as s,r as a,o as B,b as e,a as l,g as d,u as n}from"./index-Dl-dvEsR.js";const A={__name:"flexbox-utilities",setup(E){const c=[{title:"유틸리티 클래스",key:"class"},{title:"설명",key:"description"}],p=[{class:"d-flex",description:"요소를 flex 컨테이너로 설정"},{class:"flex-row, flex-column",description:"flex 방향 설정"},{class:"justify-*",description:"주 축 정렬 설정 (start, center, end 등)"},{class:"align-*",description:"교차 축 정렬 설정 (start, center, stretch 등)"},{class:"flex-wrap, flex-nowrap",description:"줄 바꿈 설정"},{class:"order-*",description:"요소의 순서 설정"},{class:"flex-grow-*, flex-shrink-*",description:"요소의 성장/축소 설정"}],f=[{title:"클래스",key:"class"},{title:"설명",key:"description"}],m=[{class:"flex-row",description:"가로 방향 (기본값)"},{class:"flex-row-reverse",description:"가로 반대 방향"},{class:"flex-column",description:"세로 방향"},{class:"flex-column-reverse",description:"세로 반대 방향"}],u=`
<template>
